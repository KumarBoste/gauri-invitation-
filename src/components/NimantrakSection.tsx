...
const FAMILY_MEMBERS: FamilyMember[] = [
  { id: '1', name: 'श्री. बाळाराम बबन बोस्टे' },
  { id: '2', name: 'श्री. प्रमोद बबन बोस्टे' },
  { id: '3', name: 'सौ. प्रतीक्षा बाळाराम बोस्टे' },
  { id: '4', name: 'सौ. प्रमिला प्रमोद बोस्टे' },
  { id: '5', name: 'कु. कुमार बाळाराम बोस्टे' },
  { id: '6', name: 'कु. सुमित बाळाराम बोस्टे' },
  { id: '7', name: 'कु. प्रणाली प्रमोद बोस्टे' },
  { id: '8', name: 'कु. स्वराली प्रमोद बोस्टे' },
];
